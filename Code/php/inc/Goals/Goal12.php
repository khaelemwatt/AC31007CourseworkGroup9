...
<head>
    ...
    <title>Responsible Consumption</title>
</head>
<?php echo "
<body class=''>
<div class='pos-f-t '>
...
<div class='container-fluid GoalTitle'>
    <H1 class='display-5 Viridian_Green'>Goal 12: Responsible Consumption And Production<br><small class=' Viridian_Green'>Ensure sustainable consumption and production patterns.</small></H1>
</div>
...
<div class=' row  justify-content-center'>
    <nav aria-label='Page navigation example'>
      <ul class='pagination pagination-lg'>
        <li class='page-item'><a class='page-link Viridian_Green' href='Goal11.php'>Previous</a></li>
	...
	<li class='page-item'><span class='page-link disabled CurrentGoal'>12</span></li>
        ...
        <li class='page-item'><a class='page-link Viridian_Green' href='Goal13.php'>Next</a></li>
      </ul>
    </nav>
    </div>
</body>"?>
